#!/usr/bin/env python3
"""Genera los cinco mapas provinciales de la Ruta del Noroeste.
...
PROVINCES = {
    "la-rioja": "departamentos-la_rioja.json",
    "catamarca": "departamentos-catamarca.json",
    "tucuman": "departamentos-tucuman.json",
    "salta": "departamentos-salta.json",
    "jujuy": "departamentos-jujuy.json",
}
