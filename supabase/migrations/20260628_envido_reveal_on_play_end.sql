-- ============================================================
-- TRUCAZO — Mostrar cartas del envido también al terminar la mano por cartas
-- Fecha: 2026-06-28
--
-- Caso hermano de 20260627_envido_reveal_cards: si la mano termina jugándose las
-- cartas (no por irse al mazo) y el ganador del envido no llegó a mostrar las
-- cartas que hicieron su tanto, igual se revelan en la mesa antes de repartir.
-- Se reusa _envido_reveal_for; el cliente ya muestra games.envido_reveal. Idempotente.
-- ============================================================
